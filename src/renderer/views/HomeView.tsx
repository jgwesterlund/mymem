...
export default function HomeView({ focused = true }: { focused?: boolean }): React.JSX.Element {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-8 py-6">
      ...
      <NoteList items={items} focused={focused} empty="No notes yet — press ⌘N, or ⌃⌘Space from anywhere." />
    </div>
  )
}
